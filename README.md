...
This Action can be used to deploy your Django project to aws Elastic beanstalk. This action can also the basic continuous integration like lint checking, running unit test and also checking for security issues. This Action can also run on specified list of python version.

## Usage

It is **important** to have the elasticbeanstalk `config.yml` of your project with its aws credentials. 
